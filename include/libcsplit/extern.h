...
#if !defined( _LIBCSPLIT_EXTERN_H )
#define _LIBCSPLIT_EXTERN_H

/* To export functions from the libcsplit DLL define LIBCSPLIT_DLL_EXPORT
 * To import functions from the libcsplit DLL define LIBCSPLIT_DLL_IMPORT
