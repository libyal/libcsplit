...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$Result = RunTestBinary ${TestExecutablesDirectory} "csplit_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$Result = RunTestBinaryWithInput ${TestExecutablesDirectory} "csplit_test_${TestName}" ${TestInput}
